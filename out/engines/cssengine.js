...
CSSEngine.RULES = [
    // ── FOCUS SUPPRESSION ───────────────────────────────────────────
    {
        ...
        message: '[HIGH] outline:none detected without :focus-visible fallback. ' +
    ...
    },
    {
        ...
        message: '[HIGH] :focus-visible { outline:none } detected. ' +
    ...
    // ── ANIMATIONS WITHOUT REDUCED MOTION ──────────────────────────
    {
        ...
        message: '[MEDIUM] Animation defined without @media (prefers-reduced-motion: reduce) guard. ' +
    ...
    },
    {
        ...
        message: '[LOW] transition: all detected without prefers-reduced-motion guard. ' +
    ...
    // ── FONT SIZE ───────────────────────────────────────────────────
    {
        ...
        message: '[MEDIUM] Font size below 11px detected. ' +
    ...
    },
    {
        ...
        message: '[LOW] Font size defined in px. ' +
    ...
    // ── LINE HEIGHT ─────────────────────────────────────────────────
    {
        ...
        message: '[LOW] line-height below 1.5 detected. ' +
    ...
    // ── OVERFLOW HIDDEN (reflow / WCAG 1.4.10) ─────────────────────
    {
        ...
        message: '[MEDIUM] overflow:hidden with a fixed height may clip content when user zooms to 400% (WCAG 1.4.10 Reflow). ' +
    ...
    // ── POINTER-EVENTS NONE ─────────────────────────────────────────
    {
        ...
        message: '[MEDIUM] pointer-events:none detected. ' +
    ...
    // ── USER-SELECT NONE ────────────────────────────────────────────
    {
        ...
        message: '[LOW] user-select:none detected. ' +
    ...
    // ── FORCED COLORS / HIGH CONTRAST ──────────────────────────────
    {
        ...
        message: '[LOW] Custom colors detected but no @media (forced-colors: active) block found. ' +
        ...
        check(content) {
            ...
            if (hasForcedColors)
                return [];
            const hasCustomColors = /background-color\s*:/i.test(content) || /\bcolor\s*:/i.test(content);
            if (!hasCustomColors)
                return [];
    ...
    // ── BOX-SHADOW AS ONLY BORDER (lost in forced-colors) ──────────
    {
        ...
        message: '[LOW] box-shadow used without a border. ' +
    ...
    // ── COLOR ONLY INDICATORS (WCAG 1.4.1) ─────────────────────────
    {
        ...
        message: '[MEDIUM] a { text-decoration:none } detected. ' +
    ...
    // ── CURSOR ──────────────────────────────────────────────────────
    {
        ...
        message: '[LOW] cursor:default detected. ' +
